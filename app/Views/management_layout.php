...
<head>
    ...
    <title>MMO Manager 2 - Dashboard</title>
    ...
    <link href="<?php echo base_url('admin-theme/css/sb-admin-2.min.css')?>" rel="stylesheet">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 mb-4">
                                ...
                                <div class="card-body">
                                    <div class="text-center">
                                        <img class="img-fluid px-3 px-sm-4 mt-3 mb-4" style="width: 25rem;"
                                            src="<?php echo base_url('admin-theme/img/undraw_posting_photo.svg')?>" alt="">
                                    </div>
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <p>MMO Manager 2 makes extensive use of Bootstrap 4 utility classes in order to reduce
